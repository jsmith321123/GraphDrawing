...
#include "qt_classes/GraphGraphicsScene.h"
...
static const char qt_meta_stringdata_GraphGraphicsScene[] = {
    "GraphGraphicsScene\0\0long\0tick()\0"
};
...
const QMetaObjectExtraData GraphGraphicsScene::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GraphGraphicsScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_GraphGraphicsScene,
      qt_meta_data_GraphGraphicsScene, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GraphGraphicsScene::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GraphGraphicsScene))
        return static_cast<void*>(const_cast< GraphGraphicsScene*>(this));
